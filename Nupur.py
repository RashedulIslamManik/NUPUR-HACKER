#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To RASHED-HUNTER
...
\033[1;91m██▓▒░____░▓███▓__░▒▓██
\033[1;91m██▓▒░___░▓██▓_____░▒▓██
\033[1;91m██▓▒░+8801829772192 ░▒▓██
\033[1;91m_██▓▒░______________░▒▓██
\033[1;91m__██▓▒░_RASHED___░▒▓██
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mRASHED-HUNTER█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
\033[1;91m║╔════════════════════╗╚╗
\033[1;92m║║██░░░░░░░░░░░░░░░░░░╚╗╚╗
\033[1;93m║║██░░░░░Rashed- Nupur░░░░░ ─║
\033[1;94m║║██░░░░░░░░░░░░░░░░░░╔╝╔╝
\033[1;95m║╚════════════════════╝╔╝
\033[1;96m╚══════════════════════╝
 """
CorrectUsername = "Rashed"
CorrectPassword = "Nupur"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:RASHED-HUNTER
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;97mWrong Password"
            os.system('xdg-open https://www.facebook.com/Tera.Yaar.hoon.main.0')
    else:
        print "\033[1;97mWrong Username"
        os.system('https:/Facebook.com/.me/Tera.Yaar.hoon.main.0')
...
def login():
	...
	print "\033[1;91m[1]\033[1;95mLogin With Facebook"
        ...
        time.sleep(0.05)
        print "\033[1;94m[4]\033[1;95mKnock me https://m.me/Tera.Yaar.hoon.main.0"
        time.sleep(0.05)
	print "\033[1;95m[5]\033[1;95mcontect me Whatsapp 01829772192For Help"
        time.sleep(0.05)
...
def pilih_login():
	...
	if peak =="":
		...
		login1()
	        ...
	        os.system('xdg-open https://www.Facebook.com/me/Tera.Yaar.hoon.main.0')
	        login()
        elif peak =="5":
	        os.system('xdg-open whatsapp number 01829772192 ')
                login()
	elif peak =="0":
		keluar()
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:RASHED-HUNTER
	print logo
...
def pilih():
	...
	if unikers =="":
		...
		print "\033[1;95m...............\033[1;91mDataReset\033[1;95m.................."
                ...
                jalan('\033[1;95m=========90%')
                jalan('\033[1;94m==========100%')
                jalan('\033[1;93mCloning Data Reset and update by RASHED')
		os.system('git pull origin master')
		raw_input('\n\x1b[1;91m[ \x1b[1;97mBack \x1b[1;91m]')
	        menu()		
	elif unikers =="0":
...
def super():
	...
	time.sleep(0.05)
	print "\033[1;92m[2]\033[1;94mClone Others people friend list"
	time.sleep(0.05)
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;34mRASHED-HUNTER\033[1;98m-----------------•"
		print logo
		jalan('\033[1;91m[+]\033[1;98mRASHED-HUNTER█████████████████▒▒▒▒▒▒▒▒..99%')
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;35mRASHED\033[1;98m-----------------•"
		print logo
		...
		try:
			...
			super()
		print"\033[1;98m[+]\033[1;94mRASHED█████████████████▒▒▒▒▒▒▒▒..100"
	...
	p.map(main, id)
#Dev:RASHED-HUNTER
        print "\033[1;98m•-----------------\033[1;38mRASHED\033[1;98m-----------------•"
...
"""
	print "\033[1;95m«-----------------\033[1;35m✅RASHED✅\033[1;95m-----------------»"
